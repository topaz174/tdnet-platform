...
DROP DATABASE IF EXISTS tdnet;
--
-- Name: tdnet; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE tdnet WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE = 'C.UTF-8';


ALTER DATABASE tdnet OWNER TO postgres;
...
--
-- Data for Name: company_master; Type: TABLE DATA; Schema: public; Owner: alex
--

COPY public.company_master (securities_code, ticker, company_name_japanese, company_name_english, company_name_kana, sector_japanese, sector_english, company_address, corporate_number, listing_classification, consolidation_yes_no, listing_date, market_status, aliases, keywords, fiscal_year_end, edinet_code, bloomberg_code, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: disclosures; Type: TABLE DATA; Schema: public; Owner: alex
--

COPY public.disclosures (id, disclosure_date, "time", company_code, company_name, title, xbrl_url, pdf_path, exchange, update_history, page_number, scraped_at, category, subcategory, embedding, xbrl_path, extraction_status, extraction_method, extraction_date, extraction_error, chunks_extracted, extraction_duration, extraction_file_path, extraction_metadata) FROM stdin;
\.


--
-- Data for Name: document_chunks; Type: TABLE DATA; Schema: public; Owner: alex
--

COPY public.document_chunks (id, disclosure_id, chunk_index, content, content_type, section_code, heading_text, char_length, tokens, vectorize, is_numeric, disclosure_hash, source_file, page_number, metadata, embedding, created_at, updated_at) FROM stdin;
\.
...
COPY public.reports (id, disclosure_id) FROM stdin;
\.


--
-- Name: disclosures_id_seq; Type: SEQUENCE SET; Schema: public; Owner: alex
--

SELECT pg_catalog.setval('public.disclosures_id_seq', 1, false);
