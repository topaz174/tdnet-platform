...
from src.database.init_db import Base as MainBase, Disclosure as MainDisclosure
from src.scraper_tdnet_search.init_db_search import Base as SearchBase, Disclosure as SearchDisclosure
...
class TDnetSearchMigrator:
    ...
    def create_backup(self):
        ...
        try:
            from src.database.backup_database import TDnetBackupManager
        ...
        try:
            from src.scraper_tdnet_search.backup_tdnet_search import TDnetSearchBackupManager
